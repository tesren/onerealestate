...
<form role="search" method="get" id="searchform" class="" action="<?php echo home_url( '/' ); ?>">
                ...
                <label for="buysell"><?php pll_e('Comprar o Rentar'); ?></label>
                <select class="form-select w-100 mb-3" aria-label="Default select example" id="buysell" name="post_type" required>
                    <option value="" selected><?php pll_e('Selecciona uno');?></option>
                    <option value="listings"><?php pll_e('Comprar');?></option>
                    <option value="rentals"><?php pll_e('Rentar');?></option>
                </select>
        ...
        <button class="btn btn1 w-100" type="submit" id="searchsubmit" value=""><?php pll_e('Buscar'); ?></button>
